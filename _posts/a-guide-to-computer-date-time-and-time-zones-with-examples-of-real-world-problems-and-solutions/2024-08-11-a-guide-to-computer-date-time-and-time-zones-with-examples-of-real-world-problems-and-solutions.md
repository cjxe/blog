...
The nature of time is complex for many reasons, one of which is different parts of the world experience it differently. This complexity creates challenges in technology by preventing us from connecting easily across the globe.

In this post, you'll learn *why* computers track date<small id="reference-date"><sup>[[1]](#definition-date)</sup></small> and time<small id="reference-time"><sup>[[2]](#definition-time)</sup></small>, *how* they do it, alongside real-world examples; so, you can work with time-based applications without the headache.
